...
```javascript
import fifo from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-fifo@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/utils-fifo/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/utils-fifo/actions/workflows/test.yml?query=branch:v0.1.1
